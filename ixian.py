...
from rsm_object_plotter import file_checker
from interplot import twodplot
...
file_index = [2] #for most recent processed data just put -1, otherwise 0 will do the first or its index
axis_1 = 'qy'
axis_2 = 'qz'
axis_3_limits = [1,240]
directory = ""
...
twodplot(f_1, f_name, axis_1, axis_2, axis_3_limits,output_folder+'images')
